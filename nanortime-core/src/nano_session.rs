...
impl NanoSession {
    ...
    pub fn save(&self, kv_data: &[u8], token_count: u32, kv_precision: u8) -> io::Result<SaveResult> {
        ...
        for i in 1..NUM_SUPERBLOCKS {
            ...
            let mut bf = OpenOptions::new().write(true).create(true).truncate(true).open(&backup_path)?;
