...
impl CostWeights {
    pub fn for_qos(mode: QosMode) -> Self {
        match mode {
            QosMode::Eco => Self { ram: 0.4, io: 0.2, energy: 0.3, latency: 0.1 },
            QosMode::Balanced => Self { ram: 0.25, io: 0.25, energy: 0.25, latency: 0.25 },
            QosMode::Performance => Self { ram: 0.1, io: 0.3, energy: 0.1, latency: 0.5 },
        }
    }
}
...
impl Default for Constraints {
    fn default() -> Self {
        Self { max_rss_mb: 1024, max_temp_c: 45, max_accuracy_loss: 0.005, min_context: 256, max_batch: 512 }
    }
}
