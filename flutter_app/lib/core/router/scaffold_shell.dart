  ...
  @override Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        // En landscape el AppBar sobra ancho: márcanos las métricas del
        ...
        actions: wide ? [
          ...
          if (dash.tempC > 0) _appChip(Icons.thermostat, '${dash.tempC.toStringAsFixed(0)}°C', dash.tempC > 45 ? colors.error : colors.info, colors),
...
? Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
                  ...
                  Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Text('NanoAI', style: GoogleFonts.inter(fontSize: 22, fontWeight: FontWeight.w800, color: colors.onSurface, letterSpacing: -0.5)),
          ...
          Padding(padding: const EdgeInsets.all(20), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            const SizedBox(height: 8),
            _info('RAM', dash.ramTotalGb > 0 ? '${dash.ramTotalGb.toStringAsFixed(2)} GB · ${dash.ramFreeGb.toStringAsFixed(2)} GB libre' : 'Desconocido', colors),
