...
/// Política permisiva para el camino feliz: tap/write como lectura (sin
/// confirmación). El PolicyEngine por defecto pide confirmación para
/// acciones de device/externalWrite — la gobernanza se prueba aparte.
...
void main() {
  ...
  test('write autónomo (política por defecto) → requiere confirmación y '
      'aborta', () async {
    final koog = Koog(
      generator: _FakeGenerator([
  ...
  test('tool desconocido → la política deniega', () async {
    final koog = Koog(
      generator: _FakeGenerator([
  ...
  test('plan vacío ejecuta sin pasos y completa (no-op)', () async {
    final koog = Koog(
