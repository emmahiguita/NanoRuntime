...
void main() {
  group('PragmaticFastPath Linguistic Logic', () {
    ...
    test('resolves reciprocal wellbeing: "bien y tu"', () {
      final res = fastPath.resolve(text: 'bien y tu', conversationId: 'conv-123');
    ...
    test('resolves reciprocal wellbeing: "todo bien y vos"', () {
      final res = fastPath.resolve(text: 'todo bien y vos', conversationId: 'conv-456');
      expect(res, isNotNull);
      expect(res!.reply, isNotEmpty);
    ...
    test('resolves pure greeting: "hola emma"', () {
      final res = fastPath.resolve(text: 'hola emma', conversationId: 'conv-123');
      expect(res, isNotNull);
    ...
    test('resolves wellbeing inquiry: "cómo estás"', () {
      final res = fastPath.resolve(text: 'cómo estás', conversationId: 'conv-123');
      expect(res, isNotNull);
      expect(res!.reply, isNotEmpty);
    ...
    test('resolves activity inquiry: "qué haces"', () {
      final res = fastPath.resolve(text: 'qué haces', conversationId: 'conv-123');
      expect(res, isNotNull);
      expect(res!.reply, isNotEmpty);
    ...
    test('resolves day inquiry: "qué tal va tu día"', () {
      final res = fastPath.resolve(text: 'qué tal va tu día', conversationId: 'conv-123');
      expect(res, isNotNull);
      expect(res!.reply, isNotEmpty);
    });

    test('resolves presence question: "estás ahí"', () {
      final res = fastPath.resolve(text: 'estás ahí', conversationId: 'conv-123');
      expect(res, isNotNull);
      expect(res!.reply, isNotEmpty);
    });

    test('resolves help request: "parce lo necesito para una tarea"', () {
      final res = fastPath.resolve(text: 'parce lo necesito para una tarea', conversationId: 'conv-123');
    ...
    test('resolves training question honestly without hallucination: "vas a ir hoy a entrenar?"', () {
      final res = fastPath.resolve(text: 'vas a ir hoy a entrenar?', conversationId: 'conv-123');
      expect(res, isNotNull);
    ...
    test('resolves multi-intent integrated message cleanly', () {
      final res = fastPath.resolve(
    ...
    test('escapes commercial intent to LLM / catalog: "cuánto vale el negro?"', () {
      final res = fastPath.resolve(text: 'cuánto vale el negro?', conversationId: 'conv-123');
      expect(res, isNull);
    });

    test('escapes support complaints to LLM / support: "el pedido me llegó malo"', () {
      final res = fastPath.resolve(text: 'el pedido me llegó malo', conversationId: 'conv-123');
      expect(res, isNull);
    });

    test('escapes automation commands: "abre WhatsApp"', () {
      final res = fastPath.resolve(text: 'abre WhatsApp', conversationId: 'conv-123');
      expect(res, isNull);
    });
  });
}
