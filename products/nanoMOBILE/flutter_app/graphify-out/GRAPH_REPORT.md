# Graph Report - flutter_app  (2026-09-17)

## Corpus Check
- 1097 files · ~1,813,205 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 16388 nodes · 23375 edges · 580 communities (552 shown, 28 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 189 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `31f03a2e`
...
1. `DesktopSessionManager` - 52 edges
2. `settingsProvider` - 47 edges
...
7. `Pruebas manuales pendientes — sprints de automatización` - 28 edges
8. `UCharIterator` - 27 edges
9. `UText` - 27 edges
10. `UTextFuncs` - 27 edges
...
## Communities (580 total, 28 thin omitted)

### Community 0 - "vnc_screen.dart"
Cohesion: 0.02
Nodes (100): _activeMask, _adaptCount, _adapting, _adaptToViewArea, _altSticky, _buildCanvas, _buildContent, _buildMinimizedPlaceholder (+92 more)
...
Cohesion: 0.03
Nodes (75): _, ../../../../core/linux/linux_distribution_registry.dart, ../../../../core/providers/kali_provider.dart, ../../../../core/theme/nano_transitions.dart, ../../../../core/widgets/nano_optical_surface.dart, ../../../features/browser/application/browser_tab_notifier.dart, ../../../features/browser/domain/browser_url_resolver.dart, ../../features/home/buho_wallpaper.dart (+67 more)

### Community 11 - "dashboard_screen.dart"
Cohesion: 0.02
Nodes (120): PolicyAllowed, PolicyDenied, PolicyRequiresApproval, MapToolArguments, ToolArguments, ClassifyConversationArguments, compose, ComposePersonalReplyArguments (+112 more)

### Community 12 - "models_screen.dart"
Cohesion: 0.02
Nodes (79): ModelViability, ratio, viabilityFor, _buildActionButton, catalog, color, colors, createState (+71 more)

### Community 13 - "chat_screen.dart"
Cohesion: 0.03
Nodes (64): chatProvider, NanoSearchDispatcher, initState, _attachFile, _AttachmentPillsStrip, attachments, _attachTextDocument, build (+56 more)
...
Cohesion: 0.04
Nodes (59): int? messageTimestamp,
  String, ConversationMemoryEntry, ConversationSearch, ConversationSearchHit, entry, maxResults, score, search (+51 more)
...
Cohesion: 0.06
Nodes (29): AccessibilityEvent, AccessibilityNodeInfo, AccessibilityService, AccessibilityEventListener, AgentAccessibilityBridge, AgentAccessibilityService, Any, Boolean (+21 more)
...
Cohesion: 0.04
Nodes (46): Color get, accent, _BottomPill, build, busy, chromeActive, chromeBase, chromeBorder (+38 more)
...
Cohesion: 0.15
Nodes (12): _binExecutor, copyPath, listFiles, movePath, NanoshellLinuxFsOperations, _quote, readFile, removePath (+4 more)

### Community 32 - "shell_executor.dart"
Cohesion: 0.05
Nodes (39): ../../features/terminal/terminal_types.dart, _assetBinDir, _baseDir, bash, bashStream, binDir, exec, _execBusyBox (+31 more)
...
Cohesion: 0.03
Nodes (73): agent_tool_protocol.dart, AgentLoop get, AgentVerifier get, handlers/browser_agent_tool_handler.dart, handlers/device_system_handler.dart, handlers/linux_tool_handler.dart, handlers/mcp_tool_handler.dart, handlers/notification_tool_handler.dart (+65 more)
...
Cohesion: 0.05
Nodes (42): engine_supervisor.dart, EnginePhase get, _api, _applyStateMap, _client, copyWith, _deliberateStop, didChangeAppLifecycleState (+34 more)
...
Cohesion: 0.07
Nodes (28): close, _closed, _closeSync, _done, _id, _inFlight, isClosed, _lastAlive (+20 more)
...
Cohesion: 0.03
Nodes (67): _, ../../features/terminal/i_bin_executor.dart, auditGroups, auditTools, checkInstalled, coverageSummary, _distDir, _downloading (+59 more)
...
Cohesion: 0.07
Nodes (26): ../agent_dependencies.dart, activeProductName, activeRole, agentId, appLabel, conversationHubListProvider, conversationId, displayName (+18 more)
...
Cohesion: 0.03
Nodes (57): accent, activeColor, _autoHideTimer, _bottomDockVisible, build, busy, _chromeHidden, colors (+49 more)
...
Cohesion: 0.02
Nodes (99): ../application/persona_context.dart, ../application/persona_import.dart, ../application/persona_repository.dart, bool isTemplate,, bool learn, enabled,, bool verified,, bool verified, enabled,, _batchDate (+91 more)

### Community 64 - "terminal_screen.dart"
Cohesion: 0.04
Nodes (63): main, prevOnError, NanoSnapshot, _api, status, package:nanoai/core/services/nano_runtime_api.dart, package:nanoai/features/automation/engine/execution/action_verifier.dart, package:nanoai/features/automation/engine/execution/agent_executor.dart (+55 more)

### Community 65 - "Java_dev_nanoai_mobile_NanoshellBridge_workerSpawnDetached"
Cohesion: 0.02
Nodes (102): ../../browser/application/browser_tab_notifier.dart, business/business_facts_providers.dart, ../../../core/providers/chat_provider.dart, ../../../core/providers/settings_provider.dart, ../../../core/services/runtime_engine.dart, ../../../core/services/shell_executor_linux_backend.dart, execution/action_path_router.dart, execution/capability_router_provider.dart (+94 more)

### Community 66 - "dashboard_provider.dart"
Cohesion: 0.10
Nodes (20): double storageTotalGb, storageFreeGb,, cpuCores, DashboardNotifier, dashboardProvider, DashboardState, dispose, enginePhase, _fetch (+12 more)

### Community 67 - "package:flutter/material.dart"
Cohesion: 0.07
Nodes (29): CurvedAnimation, animation, barrierDismissible, build, _buildCurves, child, createState, _curved (+21 more)

### Community 68 - "catalog_models.dart"
Cohesion: 0.07
Nodes (28): BrowserAutomationActionType, BrowserAutomationEngine, browserAutomationEngineProvider, BrowserAutomationResult, BrowserAutomationStep, captureScreenshot, clickElement, delay (+20 more)
...
Cohesion: 0.07
Nodes (21): ContactsChannelHandler, Any, Array, Boolean, Int, IntArray, List, Map (+13 more)
...
Cohesion: 0.04
Nodes (43): fromKey, key, network, ToolPermission, _emailRe, emails, extract, hasData (+35 more)
...
### Community 78 - "State"
Cohesion: 0.07
Nodes (33): core/linux/linux_init.dart, core/providers/app_providers.dart, core/router/app_router.dart, core/services/boot_orchestrator.dart, core/theme/app_theme.dart, core/theme/nano_motion.dart, features/automation/application/automation_coordinator_provider.dart, features/automation/headless/automation_headless_runner.dart (+25 more)

### Community 79 - "pty.c"
Cohesion: 0.02
Nodes (94): ../../application/automation_diagnostics.dart, ../../application/automation_engine.dart, ../../application/automation_engine_provider.dart, ../../application/automation_feedback_presenter.dart, ../../application/rule_creator.dart, automation_suggestion_carousel.dart, _actions, activeRulesCount (+86 more)
...
Cohesion: 0.11
Nodes (18): actualBackend, actualProvider, baseUrl, checkHealth, _createClient, ensureBridgeRunning, error, failure (+10 more)

### Community 87 - "terminal_audit_logger.dart"
Cohesion: 0.03
Nodes (93): _AgentHeader, _DashboardEntryTile, _PendingDraftsBanner, QuickAutomationActions, CustomPainter, interactive_3d_turntable_box.dart, _LiquidPainter, _NanoGlyphPainter (+85 more)

### Community 88 - "proot_manager.dart"
Cohesion: 0.03
Nodes (71): ../execution/handlers/semantic_linux_tool_handler.dart, ../execution/tool_call.dart, callTool, connect, descriptor, disconnect, _httpClient, HttpMcpClient (+63 more)
...
Cohesion: 0.05
Nodes (38): accent, accentColor, build, builder, _buildGlyph, custom, customChild, FeatherCoreIcon (+30 more)
...
Cohesion: 0.05
Nodes (37): _adapter, id, McpCandidateProvider, provide, _registry, all, isEmpty, lookup (+29 more)
...
Cohesion: 0.05
Nodes (39): Color, accent, blurSigma, borderStrength, build, child, createState, dispose (+31 more)

### Community 96 - "DeviceMetricsProvider"
Cohesion: 0.03
Nodes (68): activeNotifications, _CapabilityNotice, color, count, _dismiss, _edit, enabled, humanOwns (+60 more)
...
Cohesion: 0.06
Nodes (37): agent_executor.dart, agent_result.dart, AgentExecutor, _api, _engine, NanoAgentExecutor, resolve, setText (+29 more)
...
Cohesion: 0.08
Nodes (23): AppBootProfile, automationBenchmark, current, _fromEnv, skipsLinuxProvisioning, defaultInstance, _pick, repair (+15 more)
...
Cohesion: 0.08
Nodes (23): chat_models.dart, entryOf, file, fileOf, kind, LmCatalogEntry, ModelKind, models (+15 more)
...
Cohesion: 0.03
Nodes (74): DateIntervalInfo, BreakIterator::isBufferClone(), U_NAMESPACE_BEGIN, UBool, UObject(), UChar, DateTimePatternGenerator, DateIntervalFormat (+66 more)
...
Cohesion: 0.07
Nodes (25): _buildEmptyState, createState, dispose, initialTabIndex, initState, onSelectUrl, show, _tabCtrl (+17 more)

### Community 123 - "chat_screen.dart"
Cohesion: 0.06
Nodes (34): architecture, _cachedInstalled, defaultShell, expectedSha256, getInfo, id, initialEnvironment, install (+26 more)
...
Cohesion: 0.05
Nodes (66): _PendingRepliesSection, _RuleCardState, ConsumerState, ConsumerStatefulWidget, ConsumerWidget, settingsProvider, _buildConversationDecisionContext, pendingRepliesProvider (+58 more)
...
Cohesion: 0.06
Nodes (31): dart:async, AllowedBinaries, _cache, isAllowed, load, _loadFromAssets, _loadFuture, dispose (+23 more)

### Community 143 - ".readLimited"
Cohesion: 0.04
Nodes (52): _ActionTile, attachmentNames, build, _buildAiBody, _buildChatMarkdownStyleSheet, colors, createState, didUpdateWidget (+44 more)
...
Cohesion: 0.08
Nodes (25): ../conversation/conversation_reply_composer.dart, ../language/pragmatic_fast_path.dart, automationResult, _composer, dispatch, dispatchedText, dispatchScheduled, isReplyAttempt (+17 more)
...
Cohesion: 0.06
Nodes (43): _observer, perceive, readCount, analyze, MlKitVisionBackend, perceive, ScreenImageProvider, _backend (+35 more)

### Community 149 - "@pantalla"
Cohesion: 0.06
Nodes (33): ../governance/rule_execution_authority.dart, AgentToolPrompt, build, listNotifications, notificationKey, notificationText, NotificationToolHandler, reconcileLocalSend (+25 more)
...
Cohesion: 0.05
Nodes (36): ../execution/event_driven_waiter.dart, _capabilityRegistry, description, _dispatcher, elapsed, eventWait, executeWorkflow, expectation (+28 more)

### Community 152 - "SettingsNotifier"
Cohesion: 0.03
Nodes (72): dart:convert, i_model_metadata_datasource.dart, main, main, prevOnError, main, prevOnError, main (+64 more)
...
Cohesion: 0.05
Nodes (51): _attachAndShareFile, _attachImage, _attachPdf, _buildBottomActionBar, _buildChatBubble, _buildControlBar, _buildFallbackLastMessage, _buildHeader (+43 more)
...
Cohesion: 0.18
Nodes (10): _, dart:typed_data, buildPdfBytes, exportMarkdown, exportReport, PdfReportService, package:pdf/pdf.dart, package:pdf/widgets.dart (+2 more)
...
Cohesion: 0.05
Nodes (40): dart:ui, FocusNode?, google_account_dialog.dart, _AccountActionChip, activeColor, icon, isActive, label (+32 more)

### Community 164 - "LinuxDistribution"
Cohesion: 0.09
Nodes (25): ../business/fact_selector.dart, ../language/language_assist.dart, confidence, matchedExample, PersonaStyleMatch, PersonaStyleResolver, reply, resolve (+17 more)
...
Cohesion: 0.10
Nodes (23): automation_model.dart, automation_model_resolver.dart, cold_start_retry.dart, app, AutomationDraftWriter, _buildPrompt, _client, conversation (+15 more)
...
Cohesion: 0.08
Nodes (27): ../domain/persona_example.dart, ../domain/personal_memory.dart, ../domain/personal_style_constraints.dart, ../domain/relationship_register.dart, _exampleLine, _hash, hasRelationshipFor, load (+19 more)
...
Cohesion: 0.07
Nodes (28): conversation_agent_contract.dart, conversation_understanding.dart, ../language/temporal_location_context.dart, call, _client, _correctionAnchor, _draft, _draftTail (+20 more)
...
Cohesion: 0.04
Nodes (59): automation_settings_pickers.dart, BusinessProduct, AutomationModelMode, _buildAutonomyRow, _buildHeaderBanner, _confirmResetCatalog, _formatPrice, _productSubtitle (+51 more)
...
Cohesion: 0.03
Nodes (72): automation_planner_provider.dart, allPending, assignedAgent, automationStoresHydratedProvider, burstTurnGateProvider, canonicalConversationReplyComposerProvider, contactRateLimiterProvider, effectiveRole (+64 more)
...
Cohesion: 0.08
Nodes (24): _ExecutorScreenObserver, ScreenImage, perceive, ScreenObserver, snapshot, analyze, bounds, boundsSpace (+16 more)

### Community 189 - "String get"
Cohesion: 0.03
Nodes (91): candidate_action.dart, candidate_provider.dart, ../deterministic_catalog.dart, ../execution/action_verifier.dart, ../../execution/platform_verification.dart, ../execution/tool_registry.dart, adapt, _capabilitiesFor (+83 more)
...
Cohesion: 0.03
Nodes (49): U_NAMESPACE_BEGIN, Measure(), DateIntervalFormat::operator!=(), DateFormat, ListFormatter, MeasureFormatCacheData, MeasureUnit, NumberFormat (+41 more)
...
Cohesion: 0.05
Nodes (41): candidate_ranker.dart, candidate_selection.dart, candidate_selector.dart, candidate_set.dart, AutomationModelRole, _acceptNonEmptyPath, AutomationModelResolution, AutomationModelResolver (+33 more)

### Community 202 - "model_detail_bottom_sheet.dart"
Cohesion: 0.05
Nodes (42): ../../core/theme/design_tokens.dart, ../../../../core/theme/nano_type.dart, ../../../../core/widgets/live_animations.dart, ../../../../core/widgets/nano_components.dart, ../../data/model_source_registry.dart, ../../domain/model_viability.dart, ../../executors/notification_executor_provider.dart, build (+34 more)
...
Cohesion: 0.07
Nodes (29): AgentCallerRole, allowedExecutionModes, allowedRoles, allowsMode, allowsRole, approvalPolicy, category, defaultTimeout (+21 more)
...
Cohesion: 0.04
Nodes (51): string_view, StringClass, U_NAMESPACE_BEGIN, StringByteSink, dest_, UMemory(), value_type_or_char, value_type_or_char<StringClass, std::void_t<typename StringClass::value_type>> (+43 more)

### Community 222 - "NotificationAutomationService"
Cohesion: 0.05
Nodes (38): DevicePermissionsChannelHandler, Any, Boolean, Intent, Map, MethodCall, MethodChannel, String (+30 more)
...
Cohesion: 0.07
Nodes (28): ToolRoutedConversationReplyComposer, compose, composeSuggestions, conversationId, ConversationReplyComposer, decision, _decisionEngine, _draftSource (+20 more)

### Community 226 - "automation_goal.dart"
Cohesion: 0.17
Nodes (11): AutomationResultStatus, confirmation, executionId, isPaused, isVerifiedSuccess, pauseIndex, pauseTool, reason (+3 more)
...
Cohesion: 0.04
Nodes (50): ../../engine/messaging/conversation_hub_providers.dart, matches, ReplyIntentVocabulary, terms, ConversationSummaryItem, _avatarGradients, build, _buildAvatar (+42 more)
...
Cohesion: 0.07
Nodes (31): _, NanoThemeExtension, _AiInjectTile, attachment, _AttachSheet, build, color, command (+23 more)
...
Cohesion: 0.03
Nodes (53): FieldPosition::operator==(), U_NAMESPACE_BEGIN, UObject(), U_NAMESPACE_BEGIN, UObject(), U_NAMESPACE_BEGIN, UMemory(), FormattedList() (+45 more)
...
Cohesion: 0.04
Nodes (56): conversation_search.dart, ../../engine/agent_dependencies.dart, ../engine/planning/automation_planner.dart, LLMEngineClient, engine, llmAutomationPlannerProvider, AutomationPlanner, _buildPrompt (+48 more)
...
Cohesion: 0.25
Nodes (7): _descriptionFor, listModels, modelsDir, _toModel, package:nanoai/core/models/catalog_models.dart, package:nanoai/features/models/domain/local_model.dart, package:nanoai/features/models/domain/local_model_repository.dart
...
Cohesion: 0.05
Nodes (49): intent_firewall.dart, intent_spec.dart, broker, critic, firewall, govern, GovernanceApproved, GovernanceClarification (+41 more)
...
Cohesion: 0.04
Nodes (46): automation_dashboard.dart, currentGraph, agentExecutorProvider, AgentConsoleSection, _AgentConsoleSectionState, build, _busy, _candidates (+38 more)
...
Cohesion: 0.07
Nodes (26): activeIndex, build, bytes, color, _controller, count, createState, didUpdateWidget (+18 more)
...
Cohesion: 0.06
Nodes (30): ../execution/agent_tool_dispatcher.dart, _byGoal, clear, _evictIfNeeded, ExperienceCache, failureCount, goal, lastFailure (+22 more)
...
Cohesion: 0.08
Nodes (28): Animation, active, AnimatedActiveBorder, _AnimatedActiveBorderState, AnimatedMessageEntry, borderRadius, build, child (+20 more)

### Community 295 - "c14_benchmark.dart"
Cohesion: 0.06
Nodes (44): Compare, Char16Ptr::Char16Ptr(), ConstChar16Ptr(), ConstChar16Ptr::ConstChar16Ptr(), final(), basic_string_view, nullptr_t, T (+36 more)
...
Cohesion: 0.07
Nodes (27): _archiveOps, _binExecutor, copyPath, createTar, executeStructured, extractTar, _fsOps, gitDiff (+19 more)

### Community 307 - "DurableInbox"
Cohesion: 0.08
Nodes (16): atspi_device_get_type, ATSPI_TYPE_DEVICE(), _AtkKeyEventStruct, keycode, keyval, length, state, string (+8 more)
...
Cohesion: 0.03
Nodes (62): AutomaticKeepAliveClientMixin, EagerGestureRecognizer, controllerRegistry, controllers, createState, currentZoom, didUpdateWidget, is3DOverview (+54 more)
...
Cohesion: 0.05
Nodes (44): automation_dev_screen.dart, automation_rules_screen.dart, automation_settings_screen.dart, business_studio_screen.dart, ../../engine/business/business_facts_providers.dart, ../../engine/messaging/tone_profile_providers.dart, _openPersonalAgent, _openSettings (+36 more)
...
Cohesion: 0.06
Nodes (48): _StyleEditDialog, _StyleEditDialogState, _ActiveExecutionCard, _ActiveExecutionCardState, InteractiveGlassCard, _InteractiveGlassCardState, LiquidFluidBackground, _LiquidFluidBackgroundState (+40 more)
...
Cohesion: 0.07
Nodes (27): agent_tool_dispatcher.dart, goal_verifier.dart, ../governance/action_confirmation.dart, ActionPathRouter, coordinates, ExecutionPath, label, path (+19 more)

### Community 325 - "business_facts_providers.dart"
Cohesion: 0.07
Nodes (28): business_facts.dart, BusinessFacts, BusinessFactsStore, BusinessFactsNotifier, businessFactsStoreProvider, _load, _loading, loadPreset (+20 more)
...
Cohesion: 0.08
Nodes (25): double value, min,, colors, createState, _DesktopSection, _DesktopSectionState, dispose, divisions, fractionDigits (+17 more)
...
Cohesion: 0.05
Nodes (42): ../../application/browser_pip_notifier.dart, GestureDragStartCallback?, GestureDragUpdateCallback?, BrowserPipNotifier, activeTabId, BrowserPipMode, BrowserPipState, copyWith (+34 more)
...
Cohesion: 0.26
Nodes (8): Any, Boolean, EventChannel, Intent, MethodCall, MethodChannel, String, NotificationAutomationChannelHandler

### Community 336 - "RuntimeScope"
Cohesion: 0.15
Nodes (10): Holder, AUTOMATION, UI, Boolean, File, RuntimeScope, Boolean, File (+2 more)
...
Cohesion: 0.05
Nodes (54): browserHistoryProvider, browserPipProvider, browserTabProvider, browserWebViewRegistryProvider, BrowserHistoryBookmarksDialog, _BrowserHistoryBookmarksDialogState, build, BrowserPipOverlay (+46 more)
...
Cohesion: 0.04
Nodes (62): ../../domain/whatsapp_contact.dart, ../../executors/notification_executor.dart, allWhatsAppContactsProvider, _channel, contacts, contactsAsync, contactsPermissionProvider, filteredWhatsAppContactsProvider (+54 more)
...
Cohesion: 0.05
Nodes (38): _Image, _LerpedNanoColors, NanoColors, altSticky, build, colors, compact, ctrlSticky (+30 more)
...
Cohesion: 0.06
Nodes (37): U_NAMESPACE_BEGIN, UBool, UErrorCode, UnicodeString, Normalizer::compare(), Normalizer::isNormalized(), Normalizer::operator!=(), Normalizer::quickCheck() (+29 more)
...
Cohesion: 0.08
Nodes (25): activeTabId, Browser3DCarouselView, _Browser3DCarouselViewState, build, createState, _currentPage, currentZoom, didChangeDependencies (+17 more)

### Community 355 - "system_role.dart"
Cohesion: 0.03
Nodes (61): ../automation_visual_theme.dart, ../../../engine/mcp/http_mcp_client.dart, ../../../engine/mcp/local_device_mcp_client.dart, ../../../engine/mcp/mcp_client_port.dart, ../../../engine/mcp/mcp_connection_registry.dart, ../../../engine/mcp/mcp_store_catalog.dart, ../../../engine/orchestration/execution_journal.dart, ../../../engine/system/installed_app_catalog.dart (+53 more)

### Community 356 - "automation_headless_runner.dart"
Cohesion: 0.15
Nodes (14): ../engine/scheduling/messaging_metrics.dart, _ClaimFailure, _ClaimResult, _claimRows, _ClaimSuccess, code, container, _headlessChannel (+6 more)

### Community 357 - "buho_wallpaper.dart"
Cohesion: 0.15
Nodes (13): BuhoWallpaper, _BuhoWallpaperState, build, createState, dispose, _index, initState, _landscapeCount (+5 more)
...
Cohesion: 0.18
Nodes (11): @immutable, NanoCodeArtifact, NanoContextProvenance, NanoContextRecord, NanoUnifiedContext, NanoNavTokens, LinuxActionResult, LinuxFileEntry (+3 more)
...
Cohesion: 0.08
Nodes (24): ModelTier, active, copyWith, description, downloadState, error, fileName, id (+16 more)
...
Cohesion: 0.12
Nodes (16): ../../browser/web_knowledge_service.dart, WebKnowledgeService, empty, _externalKeywords, ExternalKnowledgeResult, fetchKnowledge, hasFacts, needsExternalKnowledge (+8 more)
...
Cohesion: 0.04
Nodes (48): active, _AddressBar, _AddressBarState, BrowserChromeBar, _BrowserMenu, build, colors, controller (+40 more)
...
Cohesion: 0.11
Nodes (18): ../language/turn_complexity_classifier.dart, _acknowledgmentTokens, analyze, _extractFullText, _extractTargetText, fullComplexity, fullText, hasContextualContinuity (+10 more)
...
Cohesion: 0.05
Nodes (37): action_path_router.dart, ../../executors/linux/linux_automation_port.dart, AgentToolProtocol, extractToolCall, extractToolCalls, _field, _findBalanced, jsonDecodeTolerant (+29 more)
...
Cohesion: 0.11
Nodes (17): args, commandArg, confirmationSignature, destinationArg, expect, hasInput, inputValue, key (+9 more)
...
Cohesion: 0.08
Nodes (25): Client, ../domain/google_account_profile.dart, _client, GoogleAccountRepository, _keyProfile, loadProfile, saveProfile, verifyGoogleConnectivity (+17 more)
...
Cohesion: 0.21
Nodes (13): pid_t, _find_own_libdir(), _login_tty(), _openpty(), pty_close(), pty_is_alive(), pty_kill(), pty_spawn() (+5 more)
...
Cohesion: 0.05
Nodes (42): ../../application/whatsapp_contacts_provider.dart, ../../domain/messaging_platform.dart, MessagingPlatform, _AppTile, _displayedPlatforms, isSelected, label, onTap (+34 more)
...
Cohesion: 0.12
Nodes (15): _, ../../infrastructure/browser_security_firewall.dart, BrowserContextExtractor, extractFullPageText, extractSelection, getSanitizedContext, BrowserDialogHelper, _buildOwlTile (+7 more)

### Community 454 - "messaging_apps_bar.dart"
Cohesion: 0.04
Nodes (48): ../engine/messaging/reply_capability.dart, ../execution/goal_verifier.dart, authority, AutomationGoal, AutomationOptions, confirmation, confirmed, executionId (+40 more)
...
Cohesion: 0.08
Nodes (22): ../../browser/web_content_formatter.dart, _decodeHtmlEntities, format, _formatHtml, _formatJsonList, _formatJsonMap, _formatPlainText, _humanizeKey (+14 more)
...
Cohesion: 0.15
Nodes (6): convert(), InputPtr, simdutf_constexpr23, convert_valid(), InputPtr, OutputPtr

### Community 473 - "listformatter.h"
Cohesion: 0.22
Nodes (9): class, isAvailable, reason, ShizukuAvailability, ShizukuAvailabilityProvider, ShizukuStatus, status, UnsupportedShizukuAvailabilityProvider (+1 more)
...
Cohesion: 0.13
Nodes (14): ../../core/services/rootfs_manager.dart, ../../../../core/services/shell_executor.dart, ../../core/services/terminal_dependencies.dart, binExecutorProvider, linuxActionVerifierProvider, linuxAutomationExecutorProvider, linuxProcessSupervisorProvider, linuxSecurityPolicyProvider (+6 more)
...
Cohesion: 0.17
Nodes (12): collectAll, collectEntry, extract, extractor, PolicySkillExtractor, SkillCollector, SkillExtractor, store (+4 more)
...
Cohesion: 0.11
Nodes (18): ../data/google_account_repository.dart, RuntimeStatus, RuntimeTelemetryNotifier, GoogleAccountProfile, connectAccount, disconnectAccount, GoogleAccountNotifier, googleAccountRepositoryProvider (+10 more)
...
Cohesion: 0.18
Nodes (13): executionJournalProvider, installedAppCatalogProvider, mcpConnectionRegistryProvider, systemGraphProvider, _openSkillsMcp, _buildHeader, _buildLiveGraphTab, _buildStoreTab (+5 more)

### Community 501 - "DeviceMetricsChannelHandler"
Cohesion: 0.17
Nodes (11): ../../../../core/models/catalog_models.dart, ../datasources/i_model_metadata_datasource.dart, ../../domain/model_metadata_entities.dart, _cacheTtl, getVerifiedModelInfo, _inFlightRequests, initialize, _localCache (+3 more)
...
Cohesion: 0.17
Nodes (11): installed_app_catalog.dart, app, AppLaunchPlan, AppLaunchResolver, call, _catalog, expectation, _openTerm (+3 more)
...
Cohesion: 0.20
Nodes (9): ../../browser/reverse_agent_client.dart, ReverseAgentClient, BrowserAgentToolHandler, _client, _displayName, executeQuery, handleCommand, matches (+1 more)
...
Cohesion: 0.20
Nodes (8): AppBuildInfo, appVersion, deviceModel, gitCommit, createToolDefinitions, MobileAutomationToolCatalog, serverId, static const String
...
Cohesion: 0.10
Nodes (18): chat_provider.dart, dashboard_provider.dart, ../../features/models/application/models_provider.dart, kali_provider.dart, ChatHistoryStore, clear, _decode, _ensureFile (+10 more)

### Community 533 - "UTransPosition"
Cohesion: 0.15
Nodes (11): localModelRepositoryProvider, modelStorageRepositoryProvider, CatalogLocalModelRepository, listModels, LocalModelRepository, local_model.dart, package:nanoai/features/models/application/models_notifier.dart, package:nanoai/features/models/application/models_state.dart (+3 more)
...
Cohesion: 0.20
Nodes (9): LinuxActionVerifier, _binExecutor, createTar, extractTar, NanoshellLinuxArchiveOperations, _securityPolicy, _verifier, linux_action_verifier.dart (+1 more)
...
Cohesion: 0.03
Nodes (72): ../agent_console_section.dart, ../automation_layout.dart, ../../engine/system/capability_availability.dart, ../../engine/system/device_permission_requester.dart, ../../engine/system/system_capability.dart, IconData, main, build (+64 more)
...
Cohesion: 0.10
Nodes (18): Duration, equivalent, maxWait, pollInterval, reason, requiredStableReadings, settled, StabilityGate (+10 more)
...
Cohesion: 0.05
Nodes (37): bool get, annotateForPrompt, authorizesExecution, ContentProvenance, hasObserved, InstructionTrust, isUserInstruction, observed (+29 more)

### Community 548 - "mcp_tool_projection.dart"
Cohesion: 0.04
Nodes (62): adaptive_swipe_calculator.dart, core/services/nano_runtime_api.dart, ../execution/agent_executor.dart, ../governance/nano_sensitive_data_policy.dart, NanoRuntimeApi, McpToolProjection, projectAll, toNanoTool (+54 more)

### Community 549 - "turn_supersede_guard.dart"
Cohesion: 0.22
Nodes (8): id, _primaryAction, provide, _resolver, SkillResolver, _store, nano_skill.dart, typedef
...
### Community 551 - "build"
Cohesion: 0.22
Nodes (8): _binExecutor, verifyArchiveIntegrity, verifyDeleted, verifyExists, verifyFileWritten, verifyTargetPresent, linux_automation_types.dart, ../../../terminal/i_bin_executor.dart
...
Cohesion: 0.25
Nodes (7): capability_router.dart, ../../executors/linux/linux_automation_executor_provider.dart, handlers/semantic_linux_tool_handler.dart, CapabilityRouter, capabilityRouterProvider, linuxExec, semanticLinuxToolHandlerProvider
...
Cohesion: 0.25
Nodes (7): _channel, copyToCatalog, isAccessibilityEnabled, openAccessibilitySettings, openChat, shareFile, WhatsAppMediaShare
...
Cohesion: 0.43
Nodes (5): AutomationConfirmationActionReceiver, dismissConfirmation(), emitConfirmationAction(), BroadcastReceiver, Context
...
Cohesion: 0.33
Nodes (5): ApprovalPolicy, ToolExecutionMode, ToolRiskLevel, ToolSideEffect, ToolVerificationPolicy
...
## Knowledge Gaps
- **10286 isolated node(s):** `UI`, `AUTOMATION`, `ChannelNames`, `TCP`, `UNIX` (+10281 more)
...
- **Why does `_S` connect `actionability_engine.dart` to `trigger_parser.dart`, `agent_tool_dispatcher_test.dart`, `runtime_engine.dart`?**
  _High betweenness centrality (0.111) - this node is a cross-community bridge._
- **Why does `operator+()` connect `agent_tool_dispatcher_test.dart` to `actionability_engine.dart`?**
  _High betweenness centrality (0.111) - this node is a cross-community bridge._
- **What connects `UI`, `AUTOMATION`, `ChannelNames` to the rest of the system?**
  _10286 weakly-connected nodes found - possible documentation gaps or missing edges._
