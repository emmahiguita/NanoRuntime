# Graph Report - flutter_app  (2026-09-22)

## Corpus Check
- 1451 files · ~1,909,366 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 19922 nodes · 28466 edges · 729 communities (686 shown, 43 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 201 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a164660e`
...
- plan_execution_coordinator.dart
...
- AllCodePoints
- AllScalarValues
- fix_automation_split_exports.ps1
- .onBind
- TaskValue
- 00-at-spi
- install-sh
...
- catalog_local_model_repository.dart
- .handleSpawnDetached
- .send
- app_providers.dart
...
- ExecutionJournal
- AnsiTerminalView
- notification_executor_provider.dart
- build
- system_capability.dart
- i_model_metadata_repository.dart
- IBinExecutor
...
- bot_definition.dart
- bot_repository.dart
- whatsapp_media_payload.dart
- whatsapp_web_bridge_controller.dart
- mcp_mobile_agent_test.dart
- DesktopSessionManager
- bot_studio_providers.dart
- automation_model_resolver.dart
- ../automation_visual_theme.dart
- whatsapp_capability_resolver.dart
- nano_account_tile.dart
- auth_user.dart
- nano_glass_field.dart
- personalization_studio_whatsapp_picker.dart
- browser_ai_tool_adapter_test.dart
- browser_window_top_bar.dart
...
- linux_voice_command_parser.dart
- persona_example.dart
- whatsapp_qr_scanner_dialog.dart
- browser_automation_models.dart
- bot_studio_screen.dart
- whatsapp_contacts_provider.dart
- bot_permissions.dart
- package:shared_preferences/shared_preferences.dart
- ContactsChannelHandler
- DesktopController
- WindowStrategy
- mcp_store_components.dart
- browser_credential_model.dart
- business_presets.dart
...
- @ejemplo
- TaskValue
- nano_android_native_ai_port.dart
- AppFunctionChannelHandler
- ChangeNotifier
- utfstring.h
...
## Communities (729 total, 43 thin omitted)
...
Cohesion: 0.02
Nodes (112): command_executor.dart, command_tagger.dart, ../../core/services/hardware_info_service.dart, cron_scheduler.dart, keyboard_mapper.dart, _accent, _after, _ansi (+104 more)
...
Cohesion: 0.02
Nodes (126): ../../application/automation_coordinator_provider.dart, automation_agent_card.dart, automation_inbox_card.dart, automation_system_footer.dart, ../automation_visual_theme.dart, ../bot_studio/bot_studio_screen.dart, business_studio_screen.dart, ConsumerWidget (+118 more)
...
Cohesion: 0.11
Nodes (17): _attemptedSpecial, build, _busy, createState, didChangeAppLifecycleState, dispose, _grantAll, _grantFlow (+9 more)
...
Cohesion: 0.06
Nodes (31): GlobalKey, build, _active, _add, build, _close, _clr, color (+23 more)

### Community 11 - "dashboard_screen.dart"
Cohesion: 0.02
Nodes (117): MapToolArguments, ToolArguments, ClassifyConversationArguments, compose, ComposePersonalReplyArguments, composeSuggestions, ConversationActions, ConversationClassificationSnapshot (+109 more)
...
Cohesion: 0.02
Nodes (106): NanoThemeExtension, AutomationVisualTheme, _AttachmentPillsStrip, attachments, _attachTextDocument, _buildChatOptionTile, _buildLandscapeChat, _buildReadingAiBody (+98 more)
...
Cohesion: 0.03
Nodes (62): ../agent_console_section.dart, automation_dev_screen.dart, ../automation_layout.dart, automation_rules_screen.dart, ../business/nano_business_screen.dart, main, personaContextProvider, NanoPersonalScreen (+54 more)
...
Cohesion: 0.04
Nodes (48): bool isDesktopMode, isDarkModeWeb,, BuildContext, context, controller, currentZoom, isDarkModeWeb, isDesktopMode, onFindInPage (+40 more)
...
Cohesion: 0.04
Nodes (47): addAttachment, addPhotoAttachment, approvePendingTool, ChatNotifierActions, clear, delete, _lastAiMessage, refreshEngine (+39 more)
...
Cohesion: 0.01
Nodes (164): _LearnBanner, _PersonalizationStudioContactsTab, _PersonalizationStudioHeader, _PersonalizationStudioImportsTab, _PersonalizationStudioMemoriesTab, Color, conversation_media_viewer.dart, IconData (+156 more)
...
Cohesion: 0.05
Nodes (38): _applyScan, cancelDownload, _CatalogReconciliation, deleteModel, _destPathFor, detected, dispose, _downloadDirPrefKey (+30 more)
...
Cohesion: 0.05
Nodes (41): engine_supervisor.dart, EnginePhase get, _api, _applyStateMap, _client, copyWith, _deliberateStop, didChangeAppLifecycleState (+33 more)
...
Cohesion: 0.06
Nodes (28): capability_router.dart, ../../executors/linux/linux_automation_executor_provider.dart, ../../executors/linux/linux_automation_port.dart, handlers/semantic_linux_tool_handler.dart, AutomationSurface, CapabilityRouter, CapabilityRoutingDecision, confidence (+20 more)
...
Cohesion: 0.05
Nodes (43): activeModel, activeModelPath, attachmentNames, attachments, availableModels, canSend, ChatAttachment, ChatAttachmentKind (+35 more)
...
Cohesion: 0.10
Nodes (19): ChangeNotifier, McpConnectionRegistry, NanoAiController, build, controller, createState, _iconFor, initState (+11 more)
...
Cohesion: 0.07
Nodes (28): ../agent_dependencies.dart, activeProductName, activeRole, agentId, appLabel, conversationHubListProvider, conversationId, displayName (+20 more)

### Community 56 - "nano_screen_shell.dart"
Cohesion: 0.02
Nodes (132): Animation, CurvedAnimation, animation, barrierDismissible, build, _buildCurves, child, createState (+124 more)
...
Cohesion: 0.07
Nodes (31): Compare, Char16Ptr::Char16Ptr(), ConstChar16Ptr::ConstChar16Ptr(), final(), basic_string_view, nullptr_t, T, u16string_view (+23 more)
...
Cohesion: 0.16
Nodes (29): jclass, jint, jlong, JNICALL, JNIEnv, jobjectArray, jstring, Java_dev_nanoai_mobile_NanoshellBridge_ptyClose() (+21 more)
...
Cohesion: 0.04
Nodes (55): main, prevOnError, NanoSnapshot, package:nanoai/features/automation/engine/execution/action_verifier.dart, package:nanoai/features/automation/engine/execution/agent_executor.dart, package:nanoai/features/automation/engine/execution/agent_result.dart, package:nanoai/features/automation/engine/execution/capability_router.dart, package:nanoai/features/automation/engine/execution/handlers/mcp_tool_handler.dart (+47 more)

### Community 65 - "Java_dev_nanoai_mobile_NanoshellBridge_workerSpawnDetached"
Cohesion: 0.02
Nodes (115): business/business_facts_providers.dart, ../../../core/services/shell_executor_linux_backend.dart, execution/action_path_router.dart, execution/capability_router_provider.dart, execution/nano_flow.dart, execution/platform_verification_router.dart, execution/stability_gate.dart, governance/intent_firewall.dart (+107 more)
...
Cohesion: 0.06
Nodes (34): _, ../../../core/models/chat_models.dart, ChatMessage, onEngineError, onEngineReady, onInferenceSuccess, onMessageAppended, onStreamingText (+26 more)
...
Cohesion: 0.15
Nodes (13): _addOrEditMemory, build, _buildMemoryCard, createState, _deleteMemory, initState, _loading, _loadMemories (+5 more)

### Community 78 - "State"
Cohesion: 0.06
Nodes (40): core/linux/linux_init.dart, core/providers/app_providers.dart, core/router/app_router.dart, core/services/boot_orchestrator.dart, core/theme/app_theme.dart, core/theme/nano_motion.dart, features/automation/application/automation_coordinator_provider.dart, features/automation/headless/automation_headless_runner.dart (+32 more)

### Community 79 - "pty.c"
Cohesion: 0.05
Nodes (46): ../../application/automation_diagnostics.dart, ../../application/automation_engine.dart, ../../application/automation_engine_provider.dart, ../../application/automation_feedback_presenter.dart, automation_dashboard_content.dart, automation_dashboard_dialogs.dart, automation_dashboard_voice_controller.dart, automation_engine_status_provider.dart (+38 more)
...
Cohesion: 0.06
Nodes (32): BorderRadius?, _ambientReflectionController, blur, borderWidth, build, child, clarity, createState (+24 more)
...
Cohesion: 0.02
Nodes (96): ../../../../core/widgets/nano_optical_surface.dart, AccountVipHeader, build, email, initials, name, onCopied, plan (+88 more)

### Community 86 - "scaffold_shell.dart"
Cohesion: 0.10
Nodes (21): BrowserWindowCardFrame, _BrowserWindowCardFrameState, build, _buildOptionsMenu, _buildResizeHandle, _buildTitleBar, child, color (+13 more)

### Community 87 - "terminal_audit_logger.dart"
Cohesion: 0.06
Nodes (31): ../../../../core/services/device_metrics.dart, dart:developer, AutomationBenchmarkReport, averageStepLatencyMs, batteryPct, cpuTempC, details, _detector (+23 more)

### Community 88 - "proot_manager.dart"
Cohesion: 0.06
Nodes (29): _defaultVoice, deviceState, DeviceSystemHandler, handleOpenAppCommand, _installedAppCatalog, listenVoice, runCapabilitiesReport, runGrantPermission (+21 more)

### Community 89 - "pty_session_registry.c"
Cohesion: 0.06
Nodes (29): actionability, AgentErrorCode, AgentExecutionResult, best, candidates, errorCode, failure, isResolved (+21 more)
...
Cohesion: 0.06
Nodes (35): LLMEngineClient, _buildPrompt, _client, decompose, LlmTaskDecomposer, _parseSemantic, _planner, _resolver (+27 more)
...
Cohesion: 0.07
Nodes (30): double value, min,, _applyPassword, build, colors, createState, _DesktopSection, _DesktopSectionState, dispose (+22 more)

### Community 96 - "DeviceMetricsProvider"
Cohesion: 0.06
Nodes (35): ConversationMemoryEntry, ConversationSearch, ConversationSearchHit, entry, maxResults, score, search, _tokens (+27 more)
...
Cohesion: 0.07
Nodes (26): ActionExpectation, VerificationOutcome, action, AgentAction, AgentLoopResult, AgentStep, AgentStepResult, attempts (+18 more)
...
Cohesion: 0.04
Nodes (27): UChar, CollationKey, CollatorFactory, GenderInfoTest, UBiDi, UBiDiTransform, UCaseMap, USet (+19 more)
...
Cohesion: 0.04
Nodes (47): AnimationController, accent, blurSigma, borderStrength, build, child, createState, dispose (+39 more)
...
Cohesion: 0.12
Nodes (16): chat_model_storage.dart, ChatModelService, checkEngine, dispose, _loadTimer, _modelSelectionRevision, newSessionId, persistModelSelection (+8 more)

### Community 143 - ".readLimited"
Cohesion: 0.03
Nodes (72): ../execution/handlers/semantic_linux_tool_handler.dart, ../execution/tool_call.dart, http_mcp_parser.dart, callTool, connect, descriptor, disconnect, _httpClient (+64 more)

### Community 144 - "dart:io"
Cohesion: 0.17
Nodes (17): dlopen(), execve(), pid_t, _call_stack_entry(), _elf_entry_of(), _load_nanoroot_for_detached(), nanoshell_spawn_busybox(), nanoshell_spawn_generic() (+9 more)
...
Cohesion: 0.04
Nodes (66): current_situation.dart, entity_identity_resolver.dart, _actionTerms, _collectNames, entity, EntityIdentity, EntityIdentityResolver, evidence (+58 more)

### Community 149 - "@pantalla"
Cohesion: 0.04
Nodes (50): ../governance/rule_execution_authority.dart, AgentToolPrompt, build, AgentToolProtocol, extractToolCall, extractToolCalls, _field, _findBalanced (+42 more)
...
Cohesion: 0.03
Nodes (74): _attachAndShareFile, _attachImage, _attachPdf, _attachVideo, _buildBottomActionBar, _buildCapabilityBadge, _buildChatBubble, _buildControlBar (+66 more)
...
Cohesion: 0.04
Nodes (50): ../engine/conversation/conversation_reply_composer.dart, ../../engine/notifications/notification_object.dart, accepted, accessGranted, accountHint, actionIndex, actions, allowedDataTypes (+42 more)

### Community 159 - "pdf_report_service.dart"
Cohesion: 0.08
Nodes (25): _, dart:typed_data, buildPdfBytes, exportMarkdown, exportReport, PdfReportService, _buildErrorWidget, ConversationPhotoViewer (+17 more)

### Community 160 - "linux_init.dart"
Cohesion: 0.07
Nodes (32): AiProviderKind get, dart:async, ../domain/ai_provider.dart, IAiProvider, apiKey, CloudApiProvider, isAvailable, kind (+24 more)
...
Cohesion: 0.04
Nodes (54): chat_control_intent.dart, chat_inference_coordinator.dart, chat_send_use_case.dart, chat_stream_session.dart, chat_tool_approval_use_case.dart, chat_tool_coordinator.dart, chat_turn_router.dart, ../../../core/services/device_info.dart (+46 more)
...
Cohesion: 0.03
Nodes (57): _, ../../../chat/nano_everywhere/nano_floating_system.dart, _AiInjectTile, attachment, _AttachSheet, build, color, command (+49 more)
...
Cohesion: 0.06
Nodes (30): conversation_doc_card.dart, conversation_link_card.dart, conversation_media_cards.dart, conversation_youtube_card.dart, ../../../engine/orchestration/execution_journal.dart, ExecutionJournalEntry, AutomationVisualPalette, build (+22 more)
...
Cohesion: 0.04
Nodes (69): endianness, match_system(), convert(), convert_with_errors(), InputPtr, result, simdutf_constexpr23, simdutf_warn_unused (+61 more)
...
Cohesion: 0.04
Nodes (45): conversation_agent_contract.dart, conversation_understanding.dart, ../language/temporal_location_context.dart, ../language/turn_complexity_classifier.dart, _acknowledgmentTokens, analyze, _extractFullText, _extractTargetText (+37 more)

### Community 173 - "VoidCallback"
Cohesion: 0.05
Nodes (37): accent, actionLabel, battery, cpu, description, freeStorage, icon, KaliStatus (+29 more)
...
Cohesion: 0.05
Nodes (45): ToneWarmth, AutomationModelMode, _buildAutonomyRow, _buildHeaderBanner, _confirmResetCatalog, _formatPrice, _productSubtitle, modelModeDescription (+37 more)
...
Cohesion: 0.02
Nodes (122): automation_planner_provider.dart, int? messageTimestamp,
  String, main, allPending, assignedAgent, assistedLearningServiceProvider, automationStoresHydratedProvider, burstTurnGateProvider (+114 more)

### Community 187 - "nano_multi_use_nav_bar.dart"
Cohesion: 0.04
Nodes (46): FocusNode get, brightness, build, compact, _controller, createState, destination, _DestinationsDock (+38 more)

### Community 188 - "screen_graph_candidate_provider.dart"
Cohesion: 0.02
Nodes (108): automation_dashboard.dart, BackdropFilter, ../../domain/data_models.dart, _LerpedNanoColors, NanoColors, build, ChoiceGroup, ChoiceOption (+100 more)

### Community 189 - "String get"
Cohesion: 0.03
Nodes (93): candidate_action.dart, candidate_provider.dart, ../deterministic_catalog.dart, ../execution/action_verifier.dart, ../../execution/platform_verification.dart, ../execution/tool_registry.dart, _ExecutorScreenObserver, adapt (+85 more)
...
Cohesion: 0.10
Nodes (19): ../domain/donation_repository.dart, checkBannerVisibility, copyWith, dismissBanner, DonationBannerState, DonationController, isInteracting, _repository (+11 more)
...
Cohesion: 0.14
Nodes (9): isManagedConfigCurrent(), Boolean, File, List, Map, Pair, String, TerminalLaunch (+1 more)

### Community 206 - "rule_pipeline.dart"
Cohesion: 0.04
Nodes (53): burst_turn_gate.dart, contact_rate_limiter.dart, event_dedupe_store.dart, BurstTurnGate, fromMap, fromNotification, NotificationEventAdapter, _coldStartReplay (+45 more)
...
Cohesion: 0.06
Nodes (33): allPending, approve, beginDispatch, _dbClient, dismiss, init, _inMemory, _loaded (+25 more)

### Community 211 - "production_wiring_test.dart"
Cohesion: 0.08
Nodes (21): dart:convert, _decodeHtmlEntities, format, _formatHtml, _formatJsonList, _formatJsonMap, _formatPlainText, _humanizeKey (+13 more)

### Community 212 - "personal_agent_cards.dart"
Cohesion: 0.09
Nodes (21): ../domain/stream_lease.dart, _activeConnections, _activeGenerationId, _activeStream, beginGeneration, cancelCooperativo, cancelStreamFlush, dispose (+13 more)
...
Cohesion: 0.15
Nodes (10): ActiveTask, IBinder, Int, Intent, List, Service, String, NanoshellWorkerService (+2 more)
...
Cohesion: 0.04
Nodes (35): Normalizer2, Normalizer2Impl, Hashtable, U_NAMESPACE_BEGIN, UObject(), U_NAMESPACE_BEGIN, UMemory(), UObject (+27 more)
...
Cohesion: 0.04
Nodes (54): ../conversation/conversation_reply_composer.dart, ../language/pragmatic_fast_path.dart, ToolRoutedConversationReplyComposer, compose, composeSuggestions, conversationId, ConversationReplyComposer, decision (+46 more)

### Community 226 - "automation_goal.dart"
Cohesion: 0.09
Nodes (22): ../application/automation_coordinator.dart, c14_metrics.dart, ../../domain/automation_goal.dart, ../engine/execution/goal_verifier.dart, automationCoordinatorProvider, base, buildBenchmarkCoordinator, C14Benchmark (+14 more)
...
Cohesion: 0.06
Nodes (34): AccessibilityPerceptionSource, ObjectMemoryPerceptionSource, OcrPerceptionSource, perceive, PerceptionSource, snapshot, VisionPerceptionSource, accessibilitySource (+26 more)

### Community 231 - "desktop_stream_chrome.dart"
Cohesion: 0.04
Nodes (43): DateInterval, DateIntervalInfo, DateTimePatternGenerator, DateInterval::getFromDate(), DateInterval::getToDate(), DateInterval::operator!=(), U_NAMESPACE_BEGIN, UDate (+35 more)

### Community 232 - "nano_transitions.dart"
Cohesion: 0.05
Nodes (38): ../../engine/messaging/conversation_hub_providers.dart, ../../engine/messaging/conversation_memory.dart, ConversationSummaryItem, _avatarGradients, build, _buildAvatar, createState, _formatTimestamp (+30 more)
...
Cohesion: 0.07
Nodes (29): csv_tsv_parser.dart, DataTable? get, activeDisplayTable, copyWith, currentQuery, currentTable, errorMessage, executeCurrentQuery (+21 more)
...
Cohesion: 0.12
Nodes (17): ../../application/database_studio_controller.dart, DatabaseStudioController, DatabaseStudioState, build, _buildSnippetChip, colors, controller, DatabaseSqlConsole (+9 more)

### Community 265 - "pragmatic_fast_path.dart"
Cohesion: 0.08
Nodes (29): browserHistoryProvider, browserPipProvider, BrowserTabModel, BrowserHistoryBookmarksDialog, _BrowserHistoryBookmarksDialogState, build, _buildEmptyState, createState (+21 more)
...
Cohesion: 0.02
Nodes (175): ../../../account/application/account_providers.dart, ../../../account/presentation/widgets/nano_support_banner.dart, ../../application/account_providers.dart, ../../../../core/theme/adaptive_theme.dart, core/theme/design_tokens.dart, ../../../../core/theme/nano_type.dart, ../../../../core/widgets/nano_components.dart, ../../../../core/widgets/nano_owl_avatar.dart (+167 more)
...
Cohesion: 0.05
Nodes (43): _, action, _byKey, confidence, fromSurface, isEmpty, _key, observations (+35 more)
...
Cohesion: 0.04
Nodes (50): ../execution/agent_tool_dispatcher.dart, ../execution/goal_verifier.dart, installed_app_catalog.dart, call, chromePackage, _clean, expectation, _extractSearchQuery (+42 more)
...
Cohesion: 0.12
Nodes (16): avatarUrl, browserAgentEnabled, cloudSyncEnabled, copyWith, displayName, email, fromJson, fromMap (+8 more)

### Community 280 - "c14_runner.dart"
Cohesion: 0.03
Nodes (67): automation_settings_pickers.dart, c14_benchmark.dart, c14_context.dart, c14_preflight.dart, ../../engine/agent_dependencies.dart, ../engine/planning/automation_planner.dart, AutomationDiagnostics, diagPrefix (+59 more)
...
Cohesion: 0.07
Nodes (26): ../../../core/services/runtime_engine.dart, notifier, state, required double peak,
  double, return, ascii, attackMs, bytes (+18 more)
...
Cohesion: 0.12
Nodes (15): _adapter, id, McpCandidateProvider, provide, _registry, all, isEmpty, lookup (+7 more)
...
Cohesion: 0.40
Nodes (3): uprv_char16PtrFromUChar(), u16string_view, u16string

### Community 296 - "personal_memory.dart"
Cohesion: 0.08
Nodes (24): copyWith, emojis, enabled, fromJson, load, _load, _loading, ready (+16 more)
...
Cohesion: 0.05
Nodes (35): bool get, eligibleForSocialPrompt, isComplex, isContextual, isNarrative, isSocialMinimal, TurnComplexity, actionTarget (+27 more)
...
Cohesion: 0.13
Nodes (14): ../../browser/application/browser_webview_registry.dart, ../domain/browser_ai_session.dart, ../infrastructure/browser_ai_session_prefs.dart, BrowserAiSessionManager, browserAiSessionManagerProvider, consumePendingPrompt, getOrCreateController, getSession (+6 more)

### Community 311 - "conversation_decision.dart"
Cohesion: 0.09
Nodes (21): conversation_autonomy_mode.dart, ConversationAgentId, ConversationAgentRole, action, agentId, agentRole, autonomyMode, autoSend (+13 more)

### Community 312 - "skill_dev_section.dart"
Cohesion: 0.05
Nodes (46): browser_webview_appearance_sync.dart, browserCredentialProvider, _onSave, BrowserCredentialsSheet, _BrowserCredentialsSheetState, build, createState, currentDomain (+38 more)
...
Cohesion: 0.04
Nodes (64): contact, _ContactLabel, controller, _ddmmy, _DetailRow, _EmptyState, error, _expanded (+56 more)
...
Cohesion: 0.09
Nodes (21): digest, sha256File, toString, allowedAction, allowLlmDraft, conversationScope, createdAt, _fingerprint (+13 more)

### Community 319 - "actionability_engine.dart"
Cohesion: 0.04
Nodes (46): dart:ui, FocusNode?, google_account_dialog.dart, _AccountActionChip, activeColor, icon, isActive, label (+38 more)
...
Cohesion: 0.10
Nodes (20): bool isVerticalStackMode,, activeTab, BrowserWindowTopBar, build, _buildTabCounter, _buildUrlBar, color, controller (+12 more)

### Community 328 - ".claimInbox"
Cohesion: 0.08
Nodes (24): ../../benchmark/c14_benchmark.dart, ../../benchmark/c14_metrics.dart, ../../benchmark/c14_runner.dart, dynamic get, C14Execution, C14RunResult, build, C14DebugBenchmarkSection (+16 more)
...
Cohesion: 0.15
Nodes (11): BroadcastReceiver, Bundle, Context, RemoteInputFixtureInstrumentation, DeviceMetricsProvider, Any, Double, Map (+3 more)
...
Cohesion: 0.06
Nodes (39): automation_model.dart, automation_model_resolver.dart, CandidateSelector, cold_start_retry.dart, AutomationModelRole, _acceptNonEmptyPath, AutomationModelResolution, AutomationModelResolver (+31 more)
...
Cohesion: 0.06
Nodes (42): browserTabProvider, browserWebViewRegistryProvider, BrowserTabBarWidget, build, getBrandColor, getBrandIcon, icon, isDark (+34 more)
...
Cohesion: 0.03
Nodes (85): ../../application/whatsapp_contacts_provider.dart, _, ../../domain/messaging_platform.dart, ../../engine/messaging/conversation_agent.dart, ../../engine/messaging/conversation_group_resolver.dart, ../../executors/notification_executor.dart, ../../executors/notification_executor_provider.dart, allWhatsAppContactsProvider (+77 more)

### Community 343 - "business_presets.dart"
Cohesion: 0.03
Nodes (72): Color get, dart:math, Hero, amp, _Blob, build, color, colors (+64 more)
...
Cohesion: 0.12
Nodes (16): ../../domain/browser_ai_response.dart, BrowserAiDomAdapter, clickSend, countMessageNodes, fillSemanticInput, waitForStabilization, _adapter, canHandle (+8 more)
...
Cohesion: 0.08
Nodes (24): activeTabId, Browser3DCarouselView, _Browser3DCarouselViewState, build, createState, _currentPage, currentZoom, didChangeDependencies (+16 more)
...
Cohesion: 0.05
Nodes (45): ConstChar16Ptr(), adoptInstead(), getAlias(), T, UBool, UErrorCode, isNull(), isValid() (+37 more)
...
Cohesion: 0.05
Nodes (39): main, prevOnError, main, main, main, main, package:flutter_test/flutter_test.dart, package:integration_test/integration_test.dart (+31 more)

### Community 364 - "whatsapp_integration_cards.dart"
Cohesion: 0.18
Nodes (9): Boolean, Int, NanoMediaDownloader, Service, String, NanoFloatingService, FrameLayout, ImageView (+1 more)
...
Cohesion: 0.08
Nodes (22): MlKitVisionBackend, analyze, bounds, boundsSpace, confidence, CoordinateSpace, expectedRole, image (+14 more)
...
Cohesion: 0.08
Nodes (26): enable_if_t, begin(), end(), friend
    std::enable_if_t<
    ...
    std::enable_if_t<
        ...
        bool>
    operator==(), basic_string_view, Unit, is_basic_string_view (+18 more)
...
Cohesion: 0.04
Nodes (49): ../domain/persona_example.dart, ../domain/persona_profile.dart, ../domain/personal_memory.dart, ../domain/personal_style_constraints.dart, ../domain/relationship_register.dart, _exampleLine, _hash, hasRelationshipFor (+41 more)
...
Cohesion: 0.07
Nodes (28): active, copyWith, description, downloadState, error, fileName, id, installed (+20 more)
...
Cohesion: 0.06
Nodes (34): Binding, Checker, contents(), getAttributes(), getOptions(), T, U_I18N_API, UBool (+26 more)
...
Cohesion: 0.08
Nodes (21): CP32, CodePointsIterator, c_, CodeUnits, CodeUnits<
        CP32,
        UnitIter,
...
Cohesion: 0.11
Nodes (17): ../../core/services/llm_engine_client.dart, baseUrl, checkHealth, _createClient, ensureBridgeRunning, getProviders, query, _queryFallback (+9 more)
...
Cohesion: 0.14
Nodes (13): ../../../../core/models/catalog_models.dart, ../datasources/i_model_metadata_datasource.dart, ../../domain/model_metadata_entities.dart, IModelLocalMetadataCache, SharedPreferencesMetadataCache, _cacheTtl, getVerifiedModelInfo, _inFlightRequests (+5 more)

### Community 387 - "system_inventory.dart"
Cohesion: 0.13
Nodes (17): behavior, UnsafeUTFImpl<
        CP32,
        UnitIter,
...
Cohesion: 0.05
Nodes (24): CharacterIterator::setToEnd(), CharacterIterator::setToStart(), ForwardCharacterIterator(), ForwardCharacterIterator::operator!=(), U_NAMESPACE_BEGIN, UObject(), U_NAMESPACE_BEGIN, namespace() (+16 more)
...
Cohesion: 0.07
Nodes (27): clearAll, delete, _getPrefs, _hashKey, _prefix, _prefsInstance, read, SecureStorageAdapter (+19 more)
...
### Community 401 - "wayland-server-core.h"
Cohesion: 0.07
...
Cohesion: 0.04
Nodes (45): conversation_key.dart, ConversationIdentity, buildIncomingEventId, canonical, conversation, conversationSafeToWrite, digest, eventId (+37 more)

### Community 409 - "agent_tool_prompt.dart"
Cohesion: 0.06
Nodes (34): actions, activity, answers, _ask, askNativeApp, cancel, checkAndClearExpandRequest, _current (+26 more)
...
### Community 416 - "dart:ui"
Cohesion: 0.11
Nodes (18): copyPath, createTar, executeStructured, extractTar, gitDiff, gitLog, gitStatus, init (+10 more)

### Community 417 - "wayland-util.h"
Cohesion: 0.09
Nodes (24): wl_fixed_t, wl_array, alloc, data, size, wl_fixed_from_double(), wl_fixed_from_int(), wl_fixed_to_double() (+16 more)

### Community 419 - "conversation_assignment_store.dart"
Cohesion: 0.06
Nodes (31): AgentConversationScope get, conversation_agent.dart, Future, address, agentForConversationId, agentId, assignedAtMs, assignmentFor (+23 more)
...
Cohesion: 0.04
Nodes (42): availableFeatures, description, displayName, isFullyConfigured, missingPrerequisites, NanoOperatingTier, OperatingTierDescriptor, satisfies (+34 more)
...
Cohesion: 0.05
Nodes (43): ../../browser/reverse_agent_client.dart, ../../browser/web_content_formatter.dart, ../../browser/web_knowledge_service.dart, ReverseAgentClient, WebKnowledgeService, _browserAiGateway, empty, _externalKeywords (+35 more)

### Community 430 - "NativeRuntimeSupervisor"
Cohesion: 0.19
Nodes (14): pid_t, _find_own_libdir(), _login_tty(), _openpty(), pty_close(), pty_is_alive(), pty_kill(), pty_spawn() (+6 more)
...
### Community 433 - "available_implementation_list"
Cohesion: 0.13
...
Cohesion: 0.15
Nodes (13): ../../domain/database_security_guard.dart, build, colors, controller, createState, DatabaseShellConnectDialog, _DatabaseShellConnectDialogState, dispose (+5 more)

### Community 436 - "dialogue_state.dart"
Cohesion: 0.11
...
Cohesion: 0.15
Nodes (13): AsyncValue, RuntimeStatus, RuntimeTelemetryNotifier, AuthController, SessionGateNotifier, AuthState, GoogleAccountProfile, GoogleAccountNotifier (+5 more)
...
### Community 445 - "browser_tab_notifier.dart"
Cohesion: 0.09
...
Cohesion: 0.08
Nodes (23): _, conversation_inapp_player.dart, conversation_photo_viewer.dart, HttpAuthResponse, ConversationMediaViewer, openExternalLink, openInAppWeb, openPdfDocument (+15 more)

### Community 454 - "messaging_apps_bar.dart"
Cohesion: 0.15
Nodes (12): conversation_agent_role.dart, ../../engine/business/fact_selector.dart, _closePhrases, _closeTokens, derive, _levelLabel, _professionalTokens, relationLineFor (+4 more)

### Community 455 - "semantic_normalizer.dart"
Cohesion: 0.04
Nodes (44): ../../../../core/services/linux_execution_backend.dart, Duration, arguments, cwd, duration, environment, executable, execute (+36 more)
...
Cohesion: 0.17
Nodes (12): _addOrEditContact, build, _buildContactCard, _contacts, createState, initState, _loadContacts, _loading (+4 more)

### Community 467 - "automation_policy.dart"
Cohesion: 0.11
Nodes (16): Brightness, fromIndex, glyph, label, NanoDestination, route, NanoGlyphType, brightness (+8 more)
...
Cohesion: 0.09
Nodes (22): actions, activeController, audioLevel, build, child, controller, createState, didChangeAppLifecycleState (+14 more)
...
Cohesion: 0.07
Nodes (30): ../language/language_assist.dart, confidence, matchedExample, PersonaStyleMatch, PersonaStyleResolver, reply, resolve, _retriever (+22 more)
...
Cohesion: 0.22
Nodes (7): std::reverse_iterator<U_HEADER_ONLY_NAMESPACE::UnsafeUTFIterator<CP32, UnitIter>>, explicit, p_, state_, units_, UnsafeCodeUnits_, reverse_iterator

### Community 481 - "std::reverse_iterator<U_HEADER_ONLY_NAMESPACE::UTFIterator<CP32, behavior, UnitIter>>"
Cohesion: 0.20
Nodes (9): std::reverse_iterator<U_HEADER_ONLY_NAMESPACE::UTFIterator<CP32, behavior, UnitIter>>, CodeUnits_, explicit, false, limit_, p_, start_, state_ (+1 more)

### Community 482 - "wayland-client-core.h"
Cohesion: 0.20
Nodes (5): timespec, wl_display, wl_event_queue, wl_interface, wl_proxy

### Community 483 - "wl_fixed_t"
Cohesion: 0.20
...
Cohesion: 0.08
Nodes (24): androidPackage, ask, error, estimatedBytes, executeAuthorizedGoal, id, kind, name (+16 more)
...
### Community 486 - "latin1_to_utf8.h"
Cohesion: 0.31
...
### Community 489 - "convert_with_errors"
Cohesion: 0.36
Nodes (7): convert(), convert_with_errors(), InputPtr, OutputPtr, result, simdutf_constexpr23, rewind_and_convert_with_errors()

### Community 490 - "xkbregistry.h"
Cohesion: 0.25
Nodes (7): rxkb_context, rxkb_iso3166_code, rxkb_iso639_code, rxkb_layout, rxkb_model, rxkb_option, rxkb_option_group

### Community 491 - ".installPackages"
Cohesion: 0.16
Nodes (11): ContactsChannelHandler, Any, Array, Boolean, Int, IntArray, List, Map (+3 more)

### Community 493 - "convert_with_errors"
Cohesion: 0.48
Nodes (6): convert(), convert_with_errors(), InputPtr, result, simdutf_constexpr23, rewind_and_convert_with_errors()

### Community 494 - "browser_context_extractor.dart"
Cohesion: 0.08
Nodes (22): ../infrastructure/browser_security_firewall.dart, BrowserContextExtractor, extractFullPageText, extractSelection, getSanitizedContext, attachController, BrowserWebViewRegistry, controllerFor (+14 more)

### Community 495 - "UIDNAInfo"
Cohesion: 0.12
Nodes (16): double phase,, audioLevel, build, createState, didChangeAppLifecycleState, didChangeDependencies, dispose, _foreground (+8 more)

### Community 496 - "nano_destination.dart"
Cohesion: 0.17
Nodes (11): ../browser_ai_dom_adapter.dart, _adapter, canHandle, countMessages, defaultUrl, displayName, id, isLoggedIn (+3 more)
...
### Community 499 - "convert_with_errors"
Cohesion: 0.47
Nodes (5): convert(), convert_with_errors(), InputPtr, OutputPtr, SIMDUTF_CPLUSPLUS20

### Community 500 - "UParseError"
Cohesion: 0.13
Nodes (14): browser_ai_provider_registry.dart, browser_ai_session_manager.dart, ../../browser/application/browser_tab_notifier.dart, ../domain/browser_ai_query.dart, ../domain/browser_ai_sanitizer.dart, listProviders, openProviderTab, _providerLocks (+6 more)

### Community 501 - "DeviceMetricsChannelHandler"
Cohesion: 0.04
Nodes (48): capability_probes.dart, MethodChannelSystemInventory, AppCapability, AppCapabilityRegistry, AppCapabilityType, AppMaturityLevel, AppProfile, _buildDiscoveredProfile (+40 more)
...
Cohesion: 0.07
Nodes (29): bool isDark,, GestureDragStartCallback?, GestureDragUpdateCallback?, BrowserPipNotifier, BrowserPipState, accent, BrowserPipSurface, build (+21 more)
...
### Community 506 - "utf32_to_latin1.h"
Cohesion: 0.67
Nodes (3): convert(), convert_with_errors(), simdutf_constexpr23

### Community 507 - "_McpSkillsHubScreenState"
Cohesion: 0.10
Nodes (20): audioLevel, build, _buildEdgeDockTab, controller, createState, didUpdateWidget, dispose, _dragging (+12 more)

### Community 508 - "convert_valid"
Cohesion: 0.50
Nodes (3): convert_valid(), InputPtr, simdutf_constexpr23

### Community 509 - "AllCodePoints"
Cohesion: 0.13
...
Cohesion: 0.14
Nodes (14): ../../domain/terminal_hub_card.dart, build, _buildCards, createState, _currentIndex, dispose, initState, _pageController (+6 more)
...
Cohesion: 0.18
Nodes (11): build, colors, controller, createState, DatabasePdfDialog, _DatabasePdfDialogState, dispose, initState (+3 more)
...
### Community 537 - "i_model_metadata_repository.dart"
Cohesion: 0.07
Nodes (27): class, _api, status, build, createState, _descController, dispose, initState (+19 more)
...
Cohesion: 0.08
Nodes (23): Client, i_model_metadata_datasource.dart, TurnMetrics, client, fullText, generationId, released, requestId (+15 more)

### Community 547 - "NotificationReplyResult"
Cohesion: 0.06
Nodes (39): ../google_account_provider.dart, googleAccountProvider, build, GoogleAccountDashboardCard, build, createState, dispose, _emailController (+31 more)

### Community 548 - "mcp_tool_projection.dart"
Cohesion: 0.04
Nodes (53): adaptive_swipe_calculator.dart, ../execution/agent_executor.dart, ../governance/nano_sensitive_data_policy.dart, NanoRuntimeApi, McpToolProjection, projectAll, toNanoTool, _api (+45 more)
...
### Community 554 - "LinuxDistribution"
Cohesion: 0.14
Nodes (14): android, Any, Boolean, EventChannel, Int, Intent, List, MethodCall (+6 more)

### Community 555 - ".onBind"
Cohesion: 0.14
Nodes (14): ../../engine/web_bridge/whatsapp_web_js_bridge.dart, InAppWebViewController?, build, _buildActionChips, _buildTopBar, createState, dispose, _progress (+6 more)
...
Cohesion: 0.14
Nodes (12): FormattedRelativeDateTime, FormattedRelativeDateTimeData, UErrorCode, NumberFormat, RelativeDateTimeCacheData, SharedBreakIterator, SharedNumberFormat, SharedPluralRules (+4 more)

### Community 560 - "notification_executor_provider.dart"
Cohesion: 0.02
Nodes (78): bool busy,, bioController, birthDate, build, _calcAge, _formatDate, gender, nameController (+70 more)
...
Cohesion: 0.08
Nodes (23): ../../domain/whatsapp_contact.dart, ../../engine/planning/contact_matcher.dart, WhatsAppContactsService, _contacts, _DefaultContactsService, handleCommand, listContacts, openChat (+15 more)
...
Cohesion: 0.04
Nodes (37): BreakIterator::isBufferClone(), U_NAMESPACE_BEGIN, UBool, UObject(), U_NAMESPACE_BEGIN, UObject(), UChar, UParseError (+29 more)
...
Cohesion: 0.06
Nodes (30): AppBuildInfo, appVersion, deviceModel, gitCommit, createToolDefinitions, MobileAutomationToolCatalog, serverId, BrowserUrlResolver (+22 more)
...
Cohesion: 0.18
Nodes (10): dispose, interval, _onEngineChanged, _poll, _ref, runtimeTelemetryProvider, _timer, llm_engine_client.dart (+2 more)
...
Cohesion: 0.10
Nodes (20): audioLevel, build, _busy, controller, createState, didUpdateWidget, initState, input (+12 more)

### Community 576 - "UTransPosition"
Cohesion: 0.08
Nodes (22): ENumberFormatSymbol, DecimalFormatSymbols::getLocale(), DecimalFormatSymbols::getSymbol(), DecimalFormatSymbols::setSymbol(), Locale, UnicodeString, DecimalQuantity, Formattable() (+14 more)
...
### Community 587 - "bot_studio_providers.dart"
Cohesion: 0.11
...
### Community 588 - "automation_model_resolver.dart"
Cohesion: 0.27
Nodes (6): Boolean, File, Int, MethodCall, MethodChannel, MediaCaptureChannelHandler

### Community 589 - "../automation_visual_theme.dart"
Cohesion: 0.07
Nodes (29): ../../../engine/mcp/http_mcp_client.dart, ../../../engine/mcp/local_device_mcp_client.dart, ../../../engine/mcp/mcp_client_port.dart, ../../../engine/mcp/mcp_connection_registry.dart, ../../../engine/mcp/mcp_store_catalog.dart, ../../../engine/system/installed_app_catalog.dart, McpToolCallResult, McpStoreItem (+21 more)

### Community 590 - "whatsapp_capability_resolver.dart"
Cohesion: 0.25
Nodes (7): localModelRepositoryProvider, modelStorageRepositoryProvider, package:nanoai/features/models/application/models_notifier.dart, package:nanoai/features/models/application/models_state.dart, package:nanoai/features/models/data/catalog_local_model_repository.dart, package:nanoai/features/models/data/channel_model_storage_repository.dart, package:nanoai/features/models/domain/model_storage_repository.dart

### Community 591 - "nano_account_tile.dart"
Cohesion: 0.04
Nodes (50): Completer, ../../core/services/kali_manager.dart, ../../core/services/proc_fs.dart, ../../core/services/terminal_dependencies.dart, dart:io, _applyAggregation, _applyOrderBy, _applyWhere (+42 more)
...
Cohesion: 0.12
Nodes (16): body, category, categoryTitle, enabled, fromRow, id, importBatch, incomingText (+8 more)

### Community 603 - "whatsapp_qr_scanner_dialog.dart"
Cohesion: 0.09
Nodes (23): ../../domain/whatsapp_media_payload.dart, ../../engine/web_bridge/whatsapp_web_bridge_controller.dart, WhatsAppWebSessionInfo, build, _copyPairingCode, createState, _decodedQrText, _domQrBytes (+15 more)

### Community 604 - "browser_automation_models.dart"
Cohesion: 0.11
...
Cohesion: 0.22
Nodes (9): core/services/nano_runtime_api.dart, AndroidCameraCaptureBackend, CameraCaptureBackend, CapturedPhoto, capturePhoto, _channel, name, path (+1 more)
...
Cohesion: 0.12
Nodes (16): bool isMedia,, NanoActivity, activity, audioLevel, build, input, isListening, isMedia (+8 more)
...
Cohesion: 0.20
Nodes (9): borderRadius, build, _buildExactPlatformLogo, MessagingPlatformIcon, paint, platform, shouldRepaint, size (+1 more)
...
Cohesion: 0.05
Nodes (42): ../../application/models_provider.dart, _, ../../../../core/providers/chat_provider.dart, ../../domain/detected_model.dart, ../../domain/local_model.dart, ../../../features/browser/application/browser_tab_notifier.dart, ../../../features/browser/domain/browser_url_resolver.dart, chatProvider (+34 more)
...
Cohesion: 0.10
Nodes (19): id, _primaryAction, provide, _resolver, SkillResolver, _store, collectAll, collectEntry (+11 more)
...
Cohesion: 0.07
Nodes (27): fromKey, key, network, ToolPermission, baseDir, bash, binDir, execRootfs (+19 more)
...
Cohesion: 0.25
Nodes (7): browser_tab_bar_widget.dart, BrowserCredentialSaveBanner, build, domain, onDismiss, onSave, username
...
Cohesion: 0.29
Nodes (5): Int, LinearLayout, String, NanoGeminiInputBar, HorizontalScrollView

### Community 645 - "SecurePathPolicy"
Cohesion: 0.33
...
Cohesion: 0.25
Nodes (8): CustomPainter, _LiquidPainter, _NanoGlyphPainter, _GmailEnvelopePainter, _SlackPainter, McpGraphEdgePainter, _WavePainter, _ScanlinePainter

### Community 650 - "nano_search_dispatcher.dart"
Cohesion: 0.15
Nodes (12): BotSkill, category, description, fromMap, hashCode, icon, id, name (+4 more)

### Community 651 - "tool_approval_result.dart"
Cohesion: 0.07
Nodes (31): ../../automation/engine/agent_dependencies.dart, ../../browser_ai/application/browser_ai_gateway.dart, ../../browser_ai/domain/browser_ai_query.dart, ../domain/chat_turn_route_result.dart, features/chat/nano_everywhere/nano_floating_wrapper.dart, ../../features/chat/nano_everywhere/nano_providers.dart, ../../features/home/buho_wallpaper.dart, _automationShortcutIndex (+23 more)
...
Cohesion: 0.06
Nodes (33): _toggleOwnership, conversationOwnershipStoreProvider, fromMap, hashCode, id, isBusiness, jid, name (+25 more)

### Community 657 - ".findTargetRootNode"
Cohesion: 0.32
Nodes (5): InteractiveWindowFinder, AccessibilityNodeInfo, AccessibilityService, Boolean, String

### Community 658 - "atspi-device.h"
Cohesion: 0.25
Nodes (4): atspi_device_get_type, ATSPI_TYPE_DEVICE(), G_BEGIN_DECLS, guint

### Community 659 - "browser_keep_alive_wrapper.dart"
Cohesion: 0.10
Nodes (18): ../../../../core/widgets/navigation/nano_navigation_panel.dart, build, initialTabIndex, build, initialTabIndex, nano_business_catalog_tab.dart, nano_business_channels_tab.dart, nano_business_header.dart (+10 more)
...
Cohesion: 0.04
Nodes (41): _, _, _, AppBootProfile, automationBenchmark, current, _fromEnv, skipsLinuxProvisioning (+33 more)

### Community 679 - "TaskValue"
Cohesion: 0.18
Nodes (11): PersonaExample, _btn, build, createState, example, _expanded, NanoPersonalExampleCard, _NanoPersonalExampleCardState (+3 more)

### Community 680 - "nano_android_native_ai_port.dart"
Cohesion: 0.11
Nodes (15): ../../automation/engine/execution/agent_tool_dispatcher.dart, _dispatcher, executeAuthorizedGoal, _handleWhatsAppIntent, NanoActionPortAdapter, NanoActionPort, NanoAnswer, NanoNativeAiPort (+7 more)
...
Cohesion: 0.15
Nodes (11): CatalogLocalModelRepository, _descriptionFor, listModels, modelsDir, _toModel, listModels, LocalModelRepository, local_model.dart (+3 more)
...
### Community 688 - "candidate_selection.dart"
Cohesion: 0.20
Nodes (7): Any, Boolean, Map, MethodChannel, String, NanoOverlayBridge, BinaryMessenger
...
Cohesion: 0.22
Nodes (8): CsvTsvParser, _detectColumnType, _detectDelimiter, equalsIgnoreCase, _inferValue, parse, _splitCsvLines, _tokenizeLine

### Community 705 - "personal_style_seed.dart"
Cohesion: 0.06
Nodes (27): _, ../domain/persona_response_option.dart, main, prevOnError, emmaCanonicalSeeds, EmmaIntentSeed, ensurePersonalStyleSeed, incomingVariants (+19 more)

### Community 706 - "_McpSkillsHubScreenState"
Cohesion: 0.33
Nodes (5): activeChannels, build, businessName, isActive, NanoBusinessHeader

### Community 707 - "whatsapp_media_resolver.dart"
Cohesion: 0.20
Nodes (9): _findClosestFile, findRecentWhatsAppImage, findRecentWhatsAppVideo, findRecentWhatsAppVoiceNote, _possibleImageDirs, _possibleVideoDirs, _possibleVoiceDirs, _resolvedCache (+1 more)

### Community 708 - "StoreDb"
Cohesion: 0.33
Nodes (6): BrowserAiProvider, ChatGptProvider, ClaudeProvider, DeepSeekProvider, GeminiProvider, MistralProvider
...
### Community 726 - "ScientificNumberFormatter"
Cohesion: 0.20
Nodes (7): U_NAMESPACE_BEGIN, UObject(), DecimalFormat, DecimalFormatSymbols, Formattable, ScientificNumberFormatter(), clone

## Knowledge Gaps
- **12504 isolated node(s):** `UI`, `AUTOMATION`, `ChannelNames`, `SniffedStream`, `TCP` (+12499 more)
...
- **Why does `_S` connect `nano_screen_shell.dart` to `desktop_audit_screen.dart`, `agent_tool_dispatcher_test.dart`?**
...
- **What connects `UI`, `AUTOMATION`, `ChannelNames` to the rest of the system?**
  _12504 weakly-connected nodes found - possible documentation gaps or missing edges._
