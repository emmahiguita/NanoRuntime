    ...
    taskOrchestrator: TaskOrchestrator(
      env: StepEnvironment(
        ...
        launchApp: (appName) async {
          ...
          // allowlisted). "Ve a Ajustes y busca X" NO es launch_app.
          ...
          // Seguridad: ante AppMatchAmbiguous NO se elige `candidates.first`.
          final String? pkg =
        ...
        // T2.7 — texto ACTUAL del campo editable (verificación de envío).
        ...
        // T2.9-verify — fingerprint de texto visible y conteo de resultados.
