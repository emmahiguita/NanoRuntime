...
class LlmAutomationPlanner implements AutomationPlanner {
  ...
  String _buildPrompt(String goal) {
    return 'Eres el planificador de automatización de Nano. Convierte el '
        ...
        'write: {"tool":"write","selector":"<sel>","text":"<txt>"}.\n'
        'linux.list: {"tool":"linux.list","args":{"path":"<ruta_absoluta>"}}.\n'
        'linux.readFile: {"tool":"linux.readFile","args":{"path":"<ruta_absoluta>"}}.\n'
        'linux.writeFile: {"tool":"linux.writeFile","args":{"path":"<ruta>","content":"<texto>"}}.\n'
        'linux.run (ejecutable + argumentos estructurados): '
        '{"tool":"linux.run","args":{"command":"<ejecutable>","arguments":["<arg1>","<arg2>"]}}.\n'
        'linux.run (script con pipes/redirecciones): '
        '{"tool":"linux.run","args":{"command":"<script bash completo>"}}.\n\n'
