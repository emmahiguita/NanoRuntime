...
class ScaffoldShell extends ConsumerWidget {
      ...
      appBar: AppBar(
        ...
        leading: Builder(
          builder: (ctx) => IconButton(
            icon: Icon(Icons.menu_rounded, color: colors.onSurface, size: 22),
        ...
        elevation: 0,
        // En landscape el AppBar sobra ancho: mostramos las metricas del
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    _chip('v2.0', colors.primary, colors),
                                    const SizedBox(width: 8),
                                    _chip('ARM64', colors.secondary, colors),
                                  ],
                                ),
                              ],
                            ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _info(
                      'RAM',
                      dash.ramTotalGb > 0
                          ? '${dash.ramTotalGb.toStringAsFixed(2)} GB · ${dash.ramFreeGb.toStringAsFixed(2)} GB libre'
                          : 'Desconocido',
                      colors,
                    ),
                    _info(
                    ...
                    _info(
                      'Almacenamiento',
                      dash.storageTotalGb > 0
                          ? '${dash.storageTotalGb.toStringAsFixed(0)} GB'
                          : 'Desconocido',
                      colors,
                    ),
                  ],
  ...
  Widget _logoMark(NanoColors c) => Container(
    width: 56,
    height: 56,
    decoration: BoxDecoration(
      ...
      boxShadow: [
        BoxShadow(color: c.primary.withValues(alpha: 0.3), blurRadius: 12),
      ],
    ),
    child: const Icon(Icons.memory_rounded, color: Colors.white, size: 32),
  );
  ...
  Widget _chip(String l, Color c, NanoColors cols) => Container(
  ...
  Widget _info(String l, String v, NanoColors c) => Padding(
