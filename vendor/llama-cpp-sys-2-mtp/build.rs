...
fn main() {
    ...
    if cfg!(feature = "cuda") {
        ...
        // NanoAI: restringir a la arquitectura real de la GPU local (RTX 3050 =
        // sm_86). Sin esto llama.cpp compila 7 arquitecturas (75..121a) y el
        // build tarda horas. Ajusta según tu GPU (sm_120 = RTX 50xx, etc.).
        let arch = std::env::var("NANO_CUDA_ARCH").unwrap_or_else(|_| "86".to_string());
